...
def extract_common_id_cookies(cookie_id_dicts, short_cutoff=6, long_cutoff=100, sim=.33):
...
def extract_known_cookies_from_db(db_name, cookie_id_dict):
    ...
    found_cookies = {}
    for domain, name, value in cur.execute('SELECT host, name, value FROM profile_cookies'):
